...
# formUrl = f"https://sesacstorage022.blob.core.windows.net/document-intelligence/로컬_RAG_에이전트_연습_계획.pdf?sp=rcwl&st=2026-07-02T00:46:36Z&se=2026-07-02T12:01:36Z&spr=https&sv=2026-02-06&sr=c&sig=l1QUcc1A%2Fy2ZA1dFL2ZDPty4%2B2ByFtYcKR3JkhMyCS4%3D"
formUrl = f"{blob_endpoint}/mock_invoice_korean.pdf?{sas_token}"

print("Blob 엔드포인트:", formUrl)
